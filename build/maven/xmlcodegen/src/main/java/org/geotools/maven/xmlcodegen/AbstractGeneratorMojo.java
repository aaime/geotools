...
public abstract class AbstractGeneratorMojo extends AbstractMojo {
    ...
    /**
     * The destination package of the generated source files in the standard dot-seperated naming
     * format.
     *
     * @parameter
     */
     ...
     *
     * <p>{@link Deprecated}, use one of {@link #sourceOutputDirectory} or {@link
     * #testOutputDirectory}
     *
    ...
    /**
     * Flag controlling whether files should override files that already exist with the same name.
     * False by default.
     *
    ...
    protected XSDSchema schema() {
        ...
        XSDSchemaLocator locator =
                new XSDSchemaLocator() {
                    ...
                    public XSDSchema locateSchema(
                        ...
                        for (XSD xsd : xsds) {
                            ...
                            if (xsd.getNamespaceURI().equals(namespaceURI)) {
                                try {
                                    ...
                                    getLog().warn(
                                                    "XSDSchemaLocator: Error occurred locating schema: "
                                                            + namespaceURI,
                                                    e);
                                }
                            }
                        ...
                        getLog().warn(
                                        "XSDSchemaLocator: Could not locate schema for: "
                                                + namespaceURI);
                        return null;
                    }
                };
        ...
        XSDSchemaLocationResolver locationResolver =
                                ...
                                Collections.singletonList(
                                        new XSDSchemaLocationResolver() {
                                            ...
                                            public String resolveSchemaLocation(
                                                ...
                                                try {
                                                    URI contextUri =
                                                            new URI(xsdSchema.getSchemaLocation());
                                                    if (contextUri.isOpaque()) {
                                                        // probably a jar:file: URL, which is opaque
                                                        // and thus not
        ...
        if (targetPrefix != null) {
            xsdSchema
                    ...
                    .put(targetPrefix, xsdSchema.getTargetNamespace());
        }

        // do some sanity checks on the schema
        if (Schemas.getTargetPrefix(xsdSchema) == null) {
            String msg =
                    "Unable to determine a prefix for the target namespace "
