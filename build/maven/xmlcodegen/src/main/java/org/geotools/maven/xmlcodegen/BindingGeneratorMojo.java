...
public class BindingGeneratorMojo extends AbstractGeneratorMojo {
    ...
    /**
     * Flag controlling whether a parser configuration ( {@link Configuration} ) the default is
     * true.
     *
    ...
    /**
     * Flag controlling whether bindings for attributes should be generated, default is false.
     *
    ...
    /**
     * Flag controlling whether bindings for elements should be generated, default is false.
     *
     * @parameter expression="false"
     */
    ...
    /**
     * Flag controlling whether bindings for types should be generated, default is true.
     *
     * @parameter expression="true"
     */
    ...
    /**
     * Flag controlling whether test for bindings should be generated, default is false.
     *
     * @parameter expression="false"
     */
    ...
    /**
     * List of constructor arguments that should be supplied to generated bindings. Each argument is
     * a 'name','type','mode' triplet. 'name' and 'type' declare the name and class of the argument
     * respectively. 'mode' can be set to "member", or "parent". If set to "member" the argument
     * will be set to a member of the binding. If set to "parent" the argument will passed through
    ...
    /**
     * The base class for complex bindings. If unspecified {@link AbstractComplexBinding} is used.
     *
    ...
    /**
     * The base class for simple bindings. If unspecified {@link AbstractSimpleBinding} is used.
     *
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        generator.setResourceLocation(
                ((Resource) project.getBuild().getResources().get(0)).getDirectory());
