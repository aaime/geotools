...
public class GeneratorUtils {
    ...
    /**
     * Returns all the types defined in <param>schema</param>, including anonymous complex types.
     *
    ...
    public static List allTypes(XSDSchema schema) {
        ...
        for (XSDTypeDefinition type : types) {
            ...
            for (Object o : particles) {
                ...
                if (element.getAnonymousTypeDefinition() != null) {
                    element.getAnonymousTypeDefinition()
                            .setName(type.getName() + "_" + element.getName());
                    anonymous.add(element.getAnonymousTypeDefinition());
                }
            }
        }
    ...
    /**
     * Returns all the types defined in <param>schema</param> whose names are included in the
     * specified set of names.
     *
     * <p>If <tt>names</tt> is null or empty all types are returned.
     *
     * @param schema the schema.
