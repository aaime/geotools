...
public class SchemaGeneratorMojo extends AbstractGeneratorMojo {
    ...
    /**
     * Flag controlling whether complex types should be composed of geotools attribute descriptors
     * which mirror the xml schema particles.
     *
     * @parameter expression="true"
     */
    ...
    String[] imports;
    /**
     * Flag controlling whether paths are printed out as the generator recurses through the schema.
     *
    ...
    /**
     * List of explicit bindings from XSD type to fully-qualified class name. Namespace defaults to
