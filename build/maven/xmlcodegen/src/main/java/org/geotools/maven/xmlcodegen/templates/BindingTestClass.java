...
public class BindingTestClass {
    ...
    protected final String TEXT_8 =
            " {"
                    ...
                    + NL
                    + "        assertEquals(  Object.class, binding( ";
    ...
    protected final String TEXT_10 =
            " ).getType() );"
                    ...
                    + NL
                    + "        assertEquals( Binding.OVERRIDE, binding( ";
    ...
    public String generate(Object argument) {
        ...
        try {
            xmls.getTransformer()
                    .transform(new DOMSource(named.getElement()), new StreamResult(writer));
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
        ...
        String className =
                named.getName().substring(0, 1).toUpperCase()
                        + named.getName().substring(1)
                        + "BindingTest";
