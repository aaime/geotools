...
public class SchemaClassTemplate {
    ...
    protected final String TEXT_12 =
            "_TYPE();" + NL + "    " + NL + "    private static ComplexType build_";
    ...
    protected final String TEXT_16 =
            "_TYPE();" + NL + "     " + NL + "    private static AttributeType build_";
    protected final String TEXT_17 = "_TYPE() {" + NL + "        AttributeType builtType;";
    protected final String TEXT_18 =
            NL + "        List<PropertyDescriptor> schema = new ArrayList<PropertyDescriptor>();";
    protected final String TEXT_19 =
            NL + "        schema.add(" + NL + "            new AttributeDescriptorImpl(";
    ...
    protected final String TEXT_26 =
            NL + "        builtType = new ComplexTypeImpl(" + NL + "            new NameImpl(\"";
    ...
    protected final String TEXT_44 =
            NL + "        builtType = new AttributeTypeImpl(" + NL + "            new NameImpl(\"";
    ...
    public String generate(Object argument) {
        ...
        for (Object value : types) {
            ...
            try {
                xmls.getTransformer()
                        .transform(new DOMSource(xsdType.getElement()), new StreamResult(writer));
            } catch (Exception e) {
                e.printStackTrace();
                return null;
            }
