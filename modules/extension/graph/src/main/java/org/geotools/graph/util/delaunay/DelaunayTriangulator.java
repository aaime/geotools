...
public class DelaunayTriangulator {
    ...
    public Graph getTriangulation() {
        // this algorithm is from "Computational Geometry: Algorithms and Applications" by M. de
        // Berg et al.,
        // written in 1997 and printed by Springer-Verlag (New York).  Pseudocode from section 9.3
        // (pp. 190-194).
