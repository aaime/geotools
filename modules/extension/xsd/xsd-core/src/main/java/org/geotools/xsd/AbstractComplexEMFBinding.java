...
public abstract class AbstractComplexEMFBinding extends AbstractComplexBinding {
    ...
    protected EObject createEObject(Object value) throws Exception {
        if (value == null || !getType().isAssignableFrom(value.getClass())) {
            ...
            Method create = factory.getClass().getMethod("create" + className, (Class<?>) null);
            ...
            // create the instance
            return (EObject) create.invoke(factory, (Object) null);
        } else {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            Method g = eObject.getClass().getMethod(methodName, (Class<?>) null);
                            if (g == null) {
                                throw e;
                            }
