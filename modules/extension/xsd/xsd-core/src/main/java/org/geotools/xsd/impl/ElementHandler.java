 ...
 * is parsed. The element handler interface is a subset of the {@link org.xml.sax.ContentHandler}
 * interface.
 *
 * <p>The methods <code>startElement, characters, and endElement</code> are called in sequence as
 * they are for normal sax content handlers.
 *
 * <p>An element handler corresponds to a specific element in a schema. A handler must return a
 * child handler for each valid child element of its corresponding element.
 *
