...
public final class FilterECQLSample {
    ...
    static {
        ...
        // -1.05 + 4.6 > aProperty";
        Add exprWithMinus = FACTORY.add(FACTORY.literal(-1.05), FACTORY.literal(4.6));
        ...
        // ----------------------------------------------------
        // 2 between 1 and 3
        filter = FACTORY.between(FACTORY.literal(2), FACTORY.literal(1), FACTORY.literal(3));
        ...
        // area( the_geom ) BETWEEN 10000 AND 30000
        filter = FACTORY.between(area, FACTORY.literal(10000), FACTORY.literal(30000));
