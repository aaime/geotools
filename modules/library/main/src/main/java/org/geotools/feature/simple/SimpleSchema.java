 ...
 *
 * <p>This schema is used to create features with simple content. It contains attribute types which
 * correspond to xml schema types from the xml schema and gml namespaces.
 *
 * <p>The attribute types in this schema maintain a unique mapping to java classes so it can be used
