...
public class DefaultTemporalDatum extends AbstractDatum implements TemporalDatum {
     ...
     * A <cite>Truncated Julian day</cite> (TJD) is defined relative to <cite>Julian day</cite> (JD) as {@code TJD = JD
     * − 2440000.5}.
     *
    ...
    /**
     * Datum for time measured since December 31, 1899 at 12:00 UTC. A <cite>Dublin Julian day</cite> (DJD) is defined
    ...
    /**
     * Constructs a temporal datum from a set of properties. The properties map is given unchanged to the
    ...
    /**
     * Returns a hash value for this temporal datum. {@linkplain #getName Name}, {@linkplain #getRemarks remarks} and
     * the like are not taken in account. In other words, two temporal datums will return the same hash value if they
