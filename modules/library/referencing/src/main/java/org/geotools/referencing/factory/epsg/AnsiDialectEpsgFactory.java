...
/**
 * An EPSG factory for the database generated by SQL scripts rather than the MS-Access one. This
 * class overrides {@link #adaptSQL} in order to translate SQL statements from MS-Access syntax to
 * ANSI syntax. By default, the translated SQL statements use the table and field names in the Data
 * Description Language (DDL) scripts provided by EPSG to create the schema for the database.
 * Subclasses can changes this default behavior by modifying the {@link #map}.
 *
 * <p><strong>References:</strong>
 *
 * <ul>
 *   <li>EPSG geodecy parameters database readme at <A
 *       HREF="http://www.ihsenergy.com/epsg/geodetic2.html">www.epsg.org</A>
 * </ul>
 *
 * @since 2.4
 * @version $Id$
