 ...
 * print()</code> and <code>parse()</code> methods, as specified by <samp>jaxb:javaType/@printMethod</samp> and
 * <samp>jaxb:javaType/@parseMethod</samp>. However, the JAXB user won't be accessing this class directly. The JAXB
 * provider is required to create an instance of this class and pass it to the JAXB runtime by invoking
 * {@link jakarta.xml.bind.DatatypeConverter#setDatatypeConverter(DatatypeConverterInterface)}. The JAXB user may access
 * this instance via the static methods of {@link jakarta.xml.bind.DatatypeConverter}.
 *
 * <p>The interface provides methods <code>parseFoo()</code> and <code>printFoo()</code> for any XML Schema type
 * <samp>foo</samp>. The <code>parseFoo()</code> method must accept any lexically valid value and convert it into the
 * corresponding canonical value. An error in the conversion routine must be mapped to a
 * {@link jakarta.xml.bind.ParseConversionEvent}.
 *
 * <p>The <code>printFoo(foo pValue)</code> method must convert the value <samp>pValue</samp> into an arbitrary lexical
...
public interface DatatypeConverterInterface {
    ...
    /**
     * Parses the lexical representation of the given integer value (arbitrary precision) and converts it into an
     * instance of {@link java.math.BigInteger}.
     *
    ...
    /**
     * Parses the lexical representation of the given 32 bit integer value and converts it into a primitive <code>int
     * </code> value.
     *
    ...
    /**
     * Parses the lexical representation of the given 64 bit integer value and converts it into a primitive <code>long
     * </code> value.
     *
    ...
    /**
     * Parses the lexical representation of the given 16 bit integer value and converts it into a primitive <code>short
     * </code> value.
     *
    ...
    /**
     * Parses the lexical representation of the given decimal value (arbitrary precision) and converts it into an
     * instance of {@link java.math.BigDecimal}.
     *
    ...
    /**
     * Parses the lexical representation of the given boolean value and converts it into a primitive <code>boolean
     * </code> value.
     *
    ...
    /**
     * Parses the lexical representation of the given 8 bit integer value and converts it into a primitive <code>byte
     * </code> value.
     *
    ...
    /**
     * Parses the lexical representation of the given qualified name and converts it into an instance of
     * {@link javax.xml.namespace.QName}. The {@link javax.xml.namespace.QName} consists of a namespace URI and a local
     * name.
     *
     * @param pLexicalXSDQName The input string being parsed, an optional namespace prefix, followed by the local name,
     *     if any. If a prefix is present, they are separated by a colon.
     * @param pNamespaceContext The namespace context is used to query mappings between prefixes and namespace URI's.
     ...
     *
     * @param pLexicalXSDBase64Binary The input string being parsed, a base 64 encoded array of bytes.
     ...
     *
     * @param pLexicalXSDHexBinary The input string being parsed, an array of bytes encoded in hex digits.
     * @return The decoded byte array.
     * @see jakarta.xml.bind.ParseConversionEvent
     */
    ...
    /**
     * Returns a lexical representation of the given instance of {@link BigInteger}, which is an integer in arbitrary
     * precision.
     *
    ...
    /**
     * Returns a lexical representation of the given instance of {@link BigDecimal}, which is a decimal number in
     * arbitrary precision.
     *
    ...
    /**
     * Returns a lexical representation of the given qualified name, which is a combination of namespace URI and local
     * name. The lexical representation is an optional prefix, which is currently mapped to namespace URI of the
     * qualified name, followed by a colon and the local name. If the namespace URI is the current default namespace
     * URI, then the prefix and the colon may be omitted.
     *
     * @param pValue The qualified name being converted.
     * @param pNamespaceContext A mapping of prefixes to namespace URI's which may be used to determine a valid prefix.
    ...
    /**
     * Returns a lexical representation of the given byte array. The lexical representation is obtained by application
     * of the base 64 encoding.
     *
    ...
    /**
     * Returns a lexical representation of the given byte array. The lexical representation is obtained by encoding any
     * byte as two hex digits.
     *
     * @param pValue The byte array being converted.
     * @return The converted byte array.
     * @see jakarta.xml.bind.PrintConversionEvent
