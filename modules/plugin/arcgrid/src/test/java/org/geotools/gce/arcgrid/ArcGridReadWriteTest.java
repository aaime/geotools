...
public class ArcGridReadWriteTest extends ArcGridBaseTestCase {
    ...
    public void writeGrassUnCompressed(File rf, File wf) throws Exception {
        ...
        final GridCoverage2D gc1 = (GridCoverage2D) reader.read((GeneralParameterValue) null);
        ...
        final GridCoverage2D gc2 = (GridCoverage2D) reader2.read((GeneralParameterValue) null);
