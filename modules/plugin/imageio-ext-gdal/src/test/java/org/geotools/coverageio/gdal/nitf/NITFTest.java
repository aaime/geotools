...
public final class NITFTest extends GDALTestCase {
    /**
     * file name of a valid NITF sample data to be used for tests. The sample data is available at <A
     * HREF="http://dl.maptools.org/dl/gdal/data/nitf/cadrg/"> cadrg sample data</A>
     */
