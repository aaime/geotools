...
public class ImageMosaicCogOnlineTest {
    ...
    public void testEmptyMosaic() throws Exception {
        ...
        try (FileWriter out =
                new FileWriter(new File(TestData.file(this, "."), "/emptyCogMosaic/datastore.properties"), StandardCharsets.UTF_8)) {
    ...
    public void testTimeDimensionMosaic() throws Exception {
        ...
        try (FileWriter out = new FileWriter(new File(TestData.file(this, "."), "/timeMosaic/datastore.properties"), StandardCharsets.UTF_8)) {
            out.write("database=cogtimemosaic\n");
            out.write(ImageMosaicReaderTest.H2_SAMPLE_PROPERTIES);
            out.flush();
        }
        try (FileWriter out = new FileWriter(new File(TestData.file(this, "."), "/timeMosaic/timeregex.properties"), StandardCharsets.UTF_8)) {
    ...
    private void harvestSingleGoogleCOG(String folder, String expected, Object source) throws IOException {
        ...
        try (FileWriter out = new FileWriter(new File(TestData.file(this, "."), folder + "/datastore.properties"), StandardCharsets.UTF_8)) {
            out.write("database=cogmosaic\n");
            out.write(ImageMosaicReaderTest.H2_SAMPLE_PROPERTIES);
            out.flush();
        }
