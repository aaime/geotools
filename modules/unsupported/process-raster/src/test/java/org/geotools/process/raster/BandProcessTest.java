...
public class BandProcessTest {
    ...
    public static void setup() throws FileNotFoundException, IOException, NoninvertibleTransformException {
        ...
        coverage1 = (GridCoverage2D) reader.read((org.geotools.api.parameter.GeneralParameterValue) null);
        // Reader disposal
        reader.dispose();
        ...
        // Read the input Coverage
        coverage3 = (GridCoverage2D) reader.read((org.geotools.api.parameter.GeneralParameterValue) null);
        // Reader disposal
        reader.dispose();
    }
